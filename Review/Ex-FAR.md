...
```
Tình huống:
Giả sử bạn đang làm việc với một hệ thống nhận diện vân tay, hệ thống này yêu cầu một người dùng đăng ký vân tay của mình vào cơ sở dữ liệu và sau đó xác nhận lại khi muốn truy cập vào một hệ thống. Các phép đo về độ chính xác của hệ thống được cho như sau:
